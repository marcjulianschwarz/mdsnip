...
import { Snippet } from "@/app/services/snippets.service";
import { useDeleteSnippet } from "@/app/hooks/useDeleteSnippet";
import { Modal } from "@/app/components/Modal/Modal";
import { useUpdateSnippet } from "@/app/hooks/useUpdateSnippet";
import { Dropdown } from "@/app/components/Dropdown/Dropdown";
import { DropDownItemType } from "@/app/components/Dropdown/DropdownComponent";
...
export default function SnippetView({ snippet }: { snippet: Snippet }) {
  ...
  const deleteSnippet = useDeleteSnippet({
    onSuccess: () =>
      showDropToast("Deleted Snippet", "delete", 2000, DropToastStyle.Warning),
    onError: () =>
  ...
  const updateSnippet = useUpdateSnippet({
    onSuccess: () =>
      showDropToast("Updated Snippet", "update", 2000, DropToastStyle.Success),
    onError: () =>
      showDropToast(
  ...
  const handleView = (snippet: Snippet) => {
    router.push("/share/" + snippet.shareCode);
  };
